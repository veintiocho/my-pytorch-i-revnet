...
def write_ori_images(image_output, display_image_num, image_directory, postfix):
    __write_images(image_output, display_image_num, '%s/ori_%s.jpg' % (image_directory, postfix))

def write_recon_images(image_output, display_image_num, image_directory, postfix):
    __write_images(image_output, display_image_num, '%s/recon_%s.jpg' % (image_directory, postfix))

def write_BNrecon_images(image_output, display_image_num, image_directory, postfix):
    __write_images(image_output, display_image_num, '%s/BNrecon_%s.jpg' % (image_directory, postfix))
